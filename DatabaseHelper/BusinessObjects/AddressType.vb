...
#Region " Private Methods "
    Private Function Insert(database As Database) As Boolean
        ...
        Try
            ...
            database.Command.CommandText = "tblAddressTypeInsert"
            'Add Busines Parameters to the command object
            database.Command.Parameters.Add("@Address", SqlDbType.VarChar).Value = _Type
    ...
    Private Function Update(database As Database) As Boolean
        ...
        Try
            database.Command.Parameters.Clear()
            database.Command.CommandType = CommandType.StoredProcedure
            database.Command.CommandText = "tblAddressTypeUpdate"
    ...
    Private Function Delete(database As Database) As Boolean
        ...
        Try
            database.Command.Parameters.Clear()
            database.Command.CommandType = CommandType.StoredProcedure
            database.Command.CommandText = "tblAddressTypeDelete"
            'Add header data parameters to the commend object (or empty buckets)
            MyBase.Initialize(database, MyBase.ID)
...
#Region " Public Methods "
    Public Function GetById(ID As Guid) As AddressType
        ...
        database.Command.CommandType = CommandType.StoredProcedure
        database.Command.CommandText = "tblAddressTypeGetById"
        database.Command.Parameters.Add("@AddressTypeId", SqlDbType.UniqueIdentifier).Value = ID
    ...
    Public Function Save() As Boolean
        ...
        Dim database = New Database("LocalZip")
        Try
