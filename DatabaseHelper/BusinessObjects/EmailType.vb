...
#Region " Private Methods "
    Private Function Insert(database As Database) As Boolean
        ...
        Try
            ...
            database.Command.Parameters.Add("@Email", SqlDbType.VarChar).Value = _Type
...
#Region " Public Methods "
    Public Function GetById(ID As Guid) As EmailType
        ...
        database.Command.CommandType = CommandType.StoredProcedure
        database.Command.CommandText = "tblEmailTypeGetById"
        database.Command.Parameters.Add("@EmailTypeId", SqlDbType.UniqueIdentifier).Value = ID
